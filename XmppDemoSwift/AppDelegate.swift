...
//  XmppDemoSwift
//
//  Created by Carlos Uribe on 15/04/16.
...
//    
    ...
    func applicationDidFinishLaunching(application: UIApplication) {
       // setupStream()
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(AppDelegate.getMessage), name: mensajesRecividos, object: nil)
    ...
    private func goOnline() {
        ...
        if domain == "gmail.com" || domain == "gtalk.com" || domain == "talk.google.com" || domain == "localhost" {
    ...
    func xmppStream(sender: XMPPStream!, didReceiveMessage message: XMPPMessage!) {
        ...
        //mensaje = message.toStr()
        NSNotificationCenter.defaultCenter().postNotificationName(mensajesRecividos, object: self)
